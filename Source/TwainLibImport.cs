...
namespace TwainInterface
{
  public partial class TwainDataSourceManager
  {
    ...
    enum TwCapBitDepthReductionType : short
    {
      THRESHOLD = 0,
      HALFTONE,
      CUSTHALFTONE,
    ...
    // On Windows, TwEvent.EventPtr will point to this structure 
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    class TwEnumeration : TwContainer
    {
      [MarshalAs(UnmanagedType.U2)]
      public TwType ItemType;
